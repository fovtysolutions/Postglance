...
<div class="sub-sidebar d-flex flex-column flex-row-auto" style="height: 100%;">
    ...
    <div class="sp-menu n-scroll sp-menu-two menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 p-l-10 p-r-10 m-b-12 fw-5">
