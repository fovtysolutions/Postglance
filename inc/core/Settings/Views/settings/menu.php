...
<div class="nav-item custom-hover-effect">
    <a class="nav-link sp-menu-item actionItem <?php _e( uri('segment', 3) == $config['id']?"active bg-light-primary":"" )?>" href="<?php _e( base_url("settings/index/" . $config['id']) )?>" data-remove-other-active="true" data-active="bg-light-primary"  data-result="html" data-content="main-wrapper" data-history="<?php _e( base_url("settings/index/" . $config['id']) )?>">
