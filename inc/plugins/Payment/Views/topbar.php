...
<div class="slide-text">
    ...
    <a id="upgrade" href="https://app2.postglance.com/pricing" class="d-none d-md-block btn btn-primary btn-sm">
    <i class="bi bi-graph-up-arrow"></i>
        <?php _e("Upgrade") ?>
    </a>   
</div>
             <div class="d-flex align-items-center">              
                <svg id="notificationIcon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#ff5c35" class="i bi-bell dropdown dropdown-hide-arrow" viewBox="0 0 16 16">
